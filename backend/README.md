...
## Project Structure
    ...
    ├── testapiautoconnect_120335  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_120335`
...
2. Clone this repo and `cd testapiautoconnect_120335`
